...
(async () => {
  ...
  // ---------- Replaced Steps 1–8 ----------
  {
    ...
    await targetPage.setViewport({ width: 1107, height: 953 });
    await delay(2000);
  }

  {
    const targetPage = page;
    await targetPage.goto('https://www.betsupersg3.com/en-sg/', {
...

  {
    ...
    await puppeteer.Locator.race([
      ...
      targetPage.locator('div._loginInput_oo0rk_5 > input'),
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/nav/header/div[2]/div/div/div/form/div[1]/div[1]/input)'),
      targetPage.locator(':scope >>> div._loginInput_oo0rk_5 > input')
    ])
      .setTimeout(timeout)
...

  {
    ...
    await puppeteer.Locator.race([
      ...
      targetPage.locator('div._passwordInput_oo0rk_10 input'),
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/nav/header/div[2]/div/div/div/form/div[1]/div[2]/div/div/input)'),
      targetPage.locator(':scope >>> div._passwordInput_oo0rk_10 input')
    ])
      .setTimeout(timeout)
  ...
  {
    const targetPage = page;
    const timeout = 10000; // define timeout to avoid ReferenceError
    await puppeteer.Locator.race([
      targetPage.locator('::-p-aria(item.name Casino) >>>> ::-p-aria(item.name)'),
      targetPage.locator('li:nth-of-type(4) img'),
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/nav/div[1]/ul/li[4]/a/div[1]/img)'),
      targetPage.locator(':scope >>> li:nth-of-type(4) img')
    ])
      .setTimeout(timeout)
      .click({
        offset: {
    ...
    console.log('Clicked Casino menu item');
    await delay(3000);
  }
...

  {
    ...
    await puppeteer.Locator.race([
      ...
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/div[4]/div/div[2]/ul/li[9]/div[1]/img)'),
    ...
    console.log('Clicked game in slot 9');
    await delay(2000);
  }
