...
(async () => {
...

  {
    const targetPage = page;
    await puppeteer.Locator.race([
      targetPage.locator('li:nth-of-type(9) img.subIcon'),
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/div[4]/div/div[2]/ul/li[9]/div/img[1])'),
      targetPage.locator(':scope >>> li:nth-of-type(9) img.subIcon')
    ])
      .setTimeout(timeout)
      .click({
        offset: {
