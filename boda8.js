...
(async () => {
  ...
  {
    const targetPage = page;
    await targetPage.goto('https://www.boda8my2.com/en-my/home', {
  ...
  {
    const targetPage = page;
    await targetPage.goto('https://www.boda8my2.com/en-my/home/casino-landing', {
      waitUntil: 'domcontentloaded',
      timeout: 0
    });
...

  {
    const targetPage = page;
    await puppeteer.Locator.race([
      targetPage.locator('::-p-aria(Casino) >>>> ::-p-aria([role="paragraph"])'),
      targetPage.locator('li:nth-of-type(4) p'),
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/nav/div[1]/ul/li[4]/a/div[1]/p)'),
      targetPage.locator(':scope >>> li:nth-of-type(4) p')
    ])
      .setTimeout(timeout)
      .click({
        offset: { x: 28.56, y: 7.64 },
      });

    console.log('Clicked Casino menu');
  }
